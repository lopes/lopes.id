...
I began writing articles on Linux and open-source tools at the [Viva o Linux (VOL)](https://www.vivaolinux.com.br/~forkd) community.
...
A brief snapshot of this phase appears in this post from October 2008: [https://pipeless.blogspot.com/2008/10/verso-prpria-v30.html](https://pipeless.blogspot.com/2008/10/verso-prpria-v30.html)

---

### 2009 — Pipeless

In January 2009, dissatisfied with the blog name, I migrated Versão Própria into *Pipeless* ([https://pipeless.blogspot.com](https://pipeless.blogspot.com)).
...
I adopted Tumblr’s micro-blogging model with *Jiloh* ([https://jiloh-blog.tumblr.com](https://jiloh-blog.tumblr.com)).
...
I returned to long-form technical writing with *Hakspek* ([https://hakspek.blogspot.com](https://hakspek.blogspot.com)).
...
With growing leadership responsibilities, I published selectively on Medium: [https://medium.com/@forkd](https://medium.com/@forkd).
...
During the COVID-19 pandemic, I launched my current and most stable project: **Lopes Logbook** — [https://lopes.id](https://lopes.id).

Key phases:

- **2020–2022:** lopes.id v1  
  Zola.386 theme, CD workflow, foundational posts
- **2022–2023:** lopes.id v2  
  Kita theme, improved tagging
- **2023–2024:** lopes.id v3  
  Repository redesign, commit standards, file naming overhaul
- **2026–Present:** lopes.id v4  
