...
Cutting-edge SIEMs have plenty of nice features, but in my experience none of them tackle log ingestion seriously. Some offload it to external tooling or plugins where you build the monitoring logic yourself; others only cover the basic case, like detecting a fully silent source. What almost none do natively is the harder, more useful thing: alert you when a source's volume deviates from its own baseline, before the gap becomes weeks wide.
