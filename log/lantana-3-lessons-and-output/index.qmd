...
date: 2026-07-31
description: "The engineering and AI lessons from building Lantana."
...
> SHOULD ADD A WORD ON THE DATA PIPELINE LEARNINGS HERE: MEDALLION, STREAMING, ENRICHMENT...
...
Three posts: [the foundations](/log/lantana-1-honeypot-as-code/), [the pipeline](/log/lantana-2-data-pipeline/), and now what it produces. Lantana is live, stable, and a little boring to operate, which is the highest compliment I can pay a system.
