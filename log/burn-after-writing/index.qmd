...
Read that line again and notice what's in it. The attacker told me who they were pretending to be, which system they wanted, and the exact story they used to get it. That was the forensic payoff of making the attacker do the work. The log wasn't "someone touched the honeypot." It was a transcript of intent.
...
They believed it. Some of the sharpest people I work with looked at that and read it as a real, embarrassing production leak. The web interface was convincing, the refusal-then-help arc felt exactly like a slightly-misconfigured internal tool, and the fake answers looked real. That afternoon was the moment the product proved itself. If skilled defenders read it as genuine, an attacker in a hurry certainly would.
...
So I stopped. I dropped Datura and put the effort into [Foxglove](https://github.com/lopes/foxglove) instead, which generates canary documents that do the detection job at a fraction of the footprint. This wasn't a failure. The technology passed every test I set for it. The economics didn't. Those are two different scoreboards, and for an internal detection tool the second one is the one that counts.
