...
Recently, however, after exploring new paradigms in AI-assisted programming, I decided to test these concepts in the wild. I applied this methodology to build the [Foxglove](https://github.com/lopes/foxglove) project, and the experience fundamentally shifted my perspective on software development. By integrating [Claude Code](https://claude.com/product/claude-code) and modern AI-assisted workflows, I realized that the way we interact with code has irrevocably changed.

:::{.callout-note title="Update 2026-06-26"}
The Antlion project was renamed to Foxglove to match the poisonous plant theme.
:::

This post traces that shift: from traditional scripting, to awkwardly forcing AI into old habits, to fully adopting *agentic* development.
...
## The New Way with LLM: Designing Foxglove to Learn the Paradigm
...
Only *after* internalizing this new paradigm did I design the [Foxglove](https://github.com/lopes/foxglove) project. Foxglove wasn't just another script; it was deliberately conceived as a sandbox to practice an AI-native methodology.
...
With my coffee in hand, I told Claude to start Phase 0. I watched it run a clean TDD loop:
...
The code under `foxglove/src` eventually felt a bit cluttered, so I prompted Claude to refactor it applying enterprise Python best practices. It modularized the project instantly. The resulting architecture was clean, professional, and highly maintainable.
...
3. **Unprecedented velocity.** Historically, a project like Foxglove would have taken me two to three weeks working 4 hours a day. Using this *agentic* workflow, the project was delivered in about 15 commits, taking less than 6 hours total. The efficiency gains are staggering.
...
By taking the time to learn the tools and paradigms, I stopped fighting the AI and started orchestrating it. Other capabilities, like [Claude Skills](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview), are next on my list. 🤖 🚀
