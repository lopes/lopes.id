...
Recently, however, after exploring new paradigms in AI-assisted programming, I decided to test these concepts in the wild. I applied this methodology to build the [Antlion](https://github.com/lopes/antlion) project, and the experience changed how I think about software development. Working with [Claude Code](https://claude.com/product/claude-code) and modern AI-assisted workflows, I realized the way we interact with code has changed for good.
...
3. **Much faster.** Historically, a project like Antlion would have taken me two to three weeks working 4 hours a day. With this *agentic* workflow, it was about 15 commits and under 6 hours total.
