...
5. **Cloudflare already has the alert I wish I'd had — I just never turned it on.** [HTTP Traffic Anomalies notifications](https://developers.cloudflare.com/notifications/reference/traffic-alerts/) exist today: a z-score past 3.5 over a rolling five minutes against the past four hours, opt-in, off by default. Mine was off for the entire month this ran. If you run your own zone, turn it on now, before you need it. This isn't a feature request; the feature shipped, I just didn't use it.
