...
Which means **blocked is not absent**, and a day of measurement said so out loud. The rule was blocking 242,127 requests a day and working exactly as designed. Total requests went from 2,745,678 to 2,777,928 — *up*. The status codes showed why: 276,736 blocks, 277,558 responses of `403`, every one of them still a row in the request count.

What blocking does change is what you send back — a few hundred bytes instead of 161 KB — and whether your origin is ever asked. Bandwidth and origin load can fall. Request totals cannot. I had chosen "reduce requests per day" as my measure of success before understanding the mechanism, and it was a number structurally incapable of moving.
