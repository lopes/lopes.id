...
::: {.callout-warning}
VMs can be **suspended** due to inactivity or by the user. When this happens, the VM's OS loses track of elapsed time, causing the **clock** to go **out of sync** 🕘 even if you have NTP enabled. Have in mind that NTP must be forced to sync if the time difference is too large. ⚠️
